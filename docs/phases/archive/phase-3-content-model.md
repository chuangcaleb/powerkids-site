...
- [x] Read `docs/reference/content-inventory.md` (since deleted — see [adr/0004](../../adr/0004-single-page-mvp-no-redirects.md)) — every field here exists to hold specific v3 content; check the source before inventing fields
